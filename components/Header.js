...
const Header = ({ page = "Arbour", showCredits = true, hasNotifications = false, grey = false }) => {

  return (
    <>
      <div className={showCredits ? styles.header : styles.header_transparent}>
        <span> {page}</span>
        ...
        <div className={styles.info_flex}>
...

          {
            hasNotifications
            ?
            <span className={styles.update}>+1 update</span>
            :
            <></>
          }
